      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-0.5">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `dashboard-nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  isActive
        ...
        <div className="p-3 border-t border-white/10">
          ...
          <button
            ...
            className="btn btn-ghost w-full justify-start mt-1 !text-ink-300 hover:!bg-white/5 hover:!text-white"
          >
            <svg
              width="16"
              height="16"

...
export default function Dashboard() {
  ...
  const complaintPie = (s.complaintsByStatus || []).map((c) => ({
    name: c._id,
    value: c.count,
  }));
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <StatCard
          ...
          tone="brand"
          icon={Icon.shield}
          hint={`${s.expiringSoon} expiring soon`}
        />
        <StatCard
          label="Overdue Visits"
          value={s.overdueVisits}
          tone="rose"
          icon={Icon.alert}
        />
        <StatCard
        ...
        <StatCard
          ...
          value={`${s.complaintResolutionRate}%`}
          tone="emerald"
          icon={Icon.chart}
        />
        <StatCard
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
        <div className="card dashboard-panel p-5 xl:col-span-2">
          <h3 className="font-bold text-ink-900 mb-4">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <LineChart data={revenueSeries}>
              ...
              <Tooltip
                ...
                contentStyle={{ borderRadius: 10, border: "1px solid #eef0f3" }}
              />
              <Line
                type="monotone"
                dataKey="revenue"
        ...
        <div className="card dashboard-panel p-5 xl:col-span-3">
          <h3 className="font-bold text-ink-900 mb-4">
            New AMC contracts (last 6 months)
          </h3>

    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          >
            ...
            <Route
              ...
              element={
                <SectionPlaceholder
                  ...
                  description="Scheduled and completed technician visits."
                />
              }
            />
            <Route
              ...
              element={
                <SectionPlaceholder
                  title="Spare Parts"
                  description="Inventory and stock levels for service parts."
                />
              }
            />
            ...
            <Route
              ...
              element={
                <SectionPlaceholder
                  title="Alert Logs"
                  description="Email and SMS alert activity."
                />
              }
            />
          </Route>
          ...
          <Route
            ...
            element={
              <ProtectedRoute roles={["technician"]}>
                <TechnicianWrap title="Today's Visits">
                  <TodayVisits />
                </TechnicianWrap>
              </ProtectedRoute>
            }
          />
          <Route
            path="/technician/visit/:id"
            element={
              <ProtectedRoute roles={["technician"]}>
                <TechnicianWrap title="Complete Visit">
                  <CompleteVisit />
                </TechnicianWrap>
              </ProtectedRoute>
            }
          ...
          <Route
            ...
            element={
              <ProtectedRoute roles={["technician"]}>
                <TechnicianWrap title="My Complaints">
